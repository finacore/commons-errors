...
func TestValidateModel(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: []baseerror.ValidationError{{Field: "User.Surname", Message: "Surname is a required field"}},
		},
		{
			name: "no-email",
		...
		},
		{
			...
			want: []baseerror.ValidationError{{Field: "User.Email", Message: "Email must be a valid email address"}},
		},
		{
